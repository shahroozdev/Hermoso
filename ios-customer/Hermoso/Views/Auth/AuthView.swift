...
/// Login / Register / OTP-verify for Hermoso App (customer). Sign-up always
/// registers as "customer" — no role selector. Mirrors AuthScreen.kt's
/// validation order and the "register does not auto-login" / "OTP verify
/// does not auto-login" behaviors.
