...
// After login the role guard rejects any non-customer account and shows a
// message directing the user to download Hermoso Business instead.
                ...
                if (otpMode) {
                    ...
                    if (result.success && !result.accessToken.isNullOrBlank() && !result.refreshToken.isNullOrBlank()) {
                        ...
                        if (role != null && role != "customer") {
                            error = "This is a business account — download Hermoso Business to sign in."
                            return@launch
                        }
                        // ────────────────────────────────────────────────────
