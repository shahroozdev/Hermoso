...
import com.hermoso.business.BuildConfig
import com.hermoso.business.ui.theme.*
import kotlinx.coroutines.Dispatchers
import kotlinx.coroutines.withContext

@Composable
private fun LegalLinkRow(label: String, url: String) {
        ...
        if (loading) {
            ...
            item {
                Card(
                    ...
                    Column(Modifier.padding(14.dp), verticalArrangement = Arrangement.spacedBy(10.dp)) {
                        Text("Legal", fontWeight = FontWeight.Bold)
                        LegalLinkRow("Privacy Policy", "${BuildConfig.WEB_BASE_URL}privacy-policy")
                        LegalLinkRow("Terms and Conditions", "${BuildConfig.WEB_BASE_URL}terms-and-conditions")
                        LegalLinkRow("Cancellation & Refund Policy", "${BuildConfig.WEB_BASE_URL}refund-policy")
                        LegalLinkRow("Ownership Statement", "${BuildConfig.WEB_BASE_URL}ownership-statement")
                    }
                }
            }
