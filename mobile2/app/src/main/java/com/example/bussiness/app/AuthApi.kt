...
import com.example.bussiness.BuildConfig
...
data class BookingItemDto(
    ...
    val status: String?,
    val price: Double?,
    val customerId: UserProfileDto?,
    val salonId: SalonDto?,
    val serviceId: ServiceDto?,
    val staffId: StaffDto?
)

data class AnalyticsMonthlyBookingDto(
    val month: String?,
...
data class OwnerDashboardChartsDto(
    val bookingsByMonth: List<AnalyticsMonthlyBookingDto>?
)
